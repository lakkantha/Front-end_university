...
@Component({
  ...
  styleUrls: ['./admission-generate.component.css']
})
...
generate()
{
  ...
  const documentDefinition = { 
      ...
      [
        ...
        },
        {
          table:{
            headerRows: 0,
            heights:25,
            widths: [ 80, 60, 120,60,130,10,15 ],
            
            body: [
              [ {text:'Programme of Study :', colSpan:3},{},{},{text:this.admission["programName"],colSpan:3,margin:[-100,0,0,0]},{},{},{text:'.',margin:[0,0,0,0]}],
              [ {text:'Academic Year/Intake :', colSpan:3},{},{},{text:this.admission['Year'], colSpan:3,margin:[-100,0,0,0]},{},{},{}],
              [ {text:'Index No:', colSpan:3},{},{},{text:this.admission['indexNo'], colSpan:3,margin:[-100,0,0,0]},{},{},{}],
              [{text:'Study Centre :'},{text:this.admission['center'],alignment:'left',margin:[-5,0,0,0]},{text:'Programme Medium :',margin:[-10,0,0,0]},{text:this.admission['medium'],alignment:'left',margin:[-15,0,0,0]},{text:'Selection Test Medium :',margin:[-25,0,0,0]},{text:this.admission['smedium'],margin:[-30,0,0,0]},{}],
            ]
          },
          layout:'noBorders',
          bold:true
        },
        {
          qr:'text only',
          fit:50,
          margin:[502,-130,0,120]

          
        },
        {
          text:'Address of the Exam Centre',
          alignment:'center',
          bold:true,
          margin:[0,0,0,10]
        },
        {
          table:{
            ...
            heights:25,
            body : [
                    [{text:this.admission['centera'],color:'#696969',alignment:'center',fontSize:11}],
                    ]
          }
        },
        {
          table:{
            ...
            body:[
            [
              {text:'Date of Examination',bold:true, border:[false,false,false,false],alignment:'right'},
              {text:this.admission['date'],color:'#696969',  fontSize:11,alignment:'center'},
              // {text:'',border:[false,false,false,false]},
              {text:'Time of Examination',bold:true,border:[false,false,false,false],alignment:'right'},
              {text:this.admission['time'],color:'#696969',  fontSize:11,alignment:'center'}
            ],
    ...
    {text:'(Not Applicable to valid OUSL record book holder)',fontSize:10,margin:[0,0,0,10]},
     {
      table:{
        widths:[150,150],
        heights:25,
        ...
        body:[
        [
          {text:'Signature of the Candidate ',bold:true, border:[false,false,false,false]},
          {text:'',color:'#696969',  fontSize:11,alignment:'center'},
        ],
    ...
    {text:'I certify that above named who is past pupil/teacher of my school/officer of my office/known to me personally placed his/her signature in my presence today',bold:true,alignment:'center',margin:[0,0,0,20]},
    {
      table:{
        widths:[50,100,50,120,100],
        heights:25,
     
        body:[
        [
          {text:'Date ',bold:true, border:[false,false,false,false]},
          {text:''},
          {text:'',border:[false,false,false,false]},
          {text:'Signature of Attestor',bold:true,border:[false,false,false,false]},
          {text:''}
        ],
    ...
    },
    {
        ...
        text:'(Once you have confirmed your selection,you cant chage your Date Time,Medium and Centre)',
        fontSize:9
      }
