...
@Component({
  selector: 'app-view-details-educational-qualification-ol',
  templateUrl: './view-details-educational-qualification-ol.component.html',
  styleUrls: ['./view-details-educational-qualification-ol.component.css']
})
export class ViewDetailsEducationalQualificationOLComponent implements OnInit {
  ...
  constructor(private modalService: BsModalService, private olService: EducationalQualificationOLService, private router: Router, private route: ActivatedRoute) { }
