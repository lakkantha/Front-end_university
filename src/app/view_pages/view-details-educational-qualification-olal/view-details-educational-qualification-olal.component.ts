...
@Component({
  selector: 'app-view-details-educational-qualification-olal',
  templateUrl: './view-details-educational-qualification-olal.component.html',
  styleUrls: ['./view-details-educational-qualification-olal.component.css']
})
export class ViewDetailsEducationalQualificationOLALComponent implements OnInit {
  ...
  constructor(private modalService: BsModalService, private olService: EducationalQualificationOLService, private alService: EducationalQualificationALService, private router: Router, private route: ActivatedRoute) { }
