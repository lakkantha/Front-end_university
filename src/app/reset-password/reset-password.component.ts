...
export class ResetPasswordComponent implements OnInit {
  ...
  constructor(private router: Router, private reset: ResetPasswordService, private modalService: BsModalService, private activatedRoute: ActivatedRoute, public nav: NavbarShowHideService) { }
